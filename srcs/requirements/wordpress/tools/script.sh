...
wget -P /var/www https://wordpress.org/wordpress-6.3.tar.gz
cd /var/www && tar -xzf /var/www/wordpress-6.3.tar.gz && rm /var/www/wordpress-6.3.tar.gz
...
wp core install --allow-root --url="https://aagouzou.42.fr" --title="aagouzou" --admin_user=${WP_ADMIN_USER} --admin_password=${WP_ADMIN_PASS} \
